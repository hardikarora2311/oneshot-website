  ...
  o.fn.YouTubePopUp = function (e) {
    ...
    o(this).on("click", function (e) {
      ...
      if (a.match(/(youtu.be)/) || a.match(/(youtube.com)/))
        var c =
          "https://www.youtube.com/embed/" + i + "?vq=hd1080&autoplay=" + u.autoplay;
...
!(function (a) {
  ...
  a.magnificPopup.registerModule(P, {
    options: {
      markup:
        '<div class="mfp-iframe-scaler"><div class="mfp-close"></div><iframe class="mfp-iframe" src="//about:blank" frameborder="0" allow="autoplay" allowfullscreen></iframe></div>',
      srcAction: "iframe_src",
      patterns: {
        youtube: {
          index: "youtube.com",
          id: "v=",
          src: "//www.youtube.com/embed/%id%?vq=hd1080&autoplay=1",
        },
        vimeo: {
          index: "vimeo.com/",
          id: "/",
